...
impl TableHeap {
    ...
    ///
    /// This function inserts the given tuple into the table. If the last page  
    /// in the table has enough space for the tuple, it is inserted there.     
    /// Otherwise, a new page is allocated and the tuple is inserted there.
    ///
    /// Parameters:
