...
//     ///
//     /// This function inserts the given tuple into the table. If the last
// page     /// in the table has enough space for the tuple, it is inserted
// there.     /// Otherwise, a new page is allocated and the tuple is inserted
// there.     ///
//     /// Parameters:
...
//     ///
//     /// Returns:
//     /// An `Option` containing the `Rid` of the inserted tuple if successful,
//     /// otherwise `None`.
//     pub fn insert_tuple(&mut self, meta: &TupleMeta, tuple: &Tuple) ->
// Option<Rid> {         let mut last_page_id = self.last_page_id;
//         let last_page = self
//             .buffer_pool_manager
...
//     pub fn iter(&mut self, start_at: Option<Rid>, stop_at: Option<Rid>) ->
...
// impl TableIterator {
//     pub fn next(&mut self, table_heap: &mut TableHeap) -> Option<(TupleMeta,
// Tuple)> {         if self.rid.is_none() {
//             return None;
//         }
...
//         let disk_manager =
// disk_manager::DiskManager::new(db_path.to_string());         let
// buffer_pool_manager = BufferPoolManager::new(10, Arc::new(disk_manager));
...
//         let disk_manager =
// disk_manager::DiskManager::new(db_path.to_string());         let
// buffer_pool_manager = BufferPoolManager::new(1000, Arc::new(disk_manager));
